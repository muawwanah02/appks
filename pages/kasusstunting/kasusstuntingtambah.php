...
<div id="tengah">
    <div class="col">
        ...
        if (isset($_POST['simpan_button'])) {
            ...
            $insertSQL = "INSERT INTO kasus_stunting SET anak_id='$anak_id', tanggal_tercatat='$tanggal_tercatat',
    ...
    <div class="col">
        <div class="card px-3 py-3">
            <form action="" method="post">
                <?php
                $selectSQLAnak = "SELECT anak.*, gizi_anak.status_gizi FROM anak 
                LEFT JOIN gizi_anak ON anak.id = gizi_anak.anak_id WHERE gizi_anak.status_gizi = 'kurang'";
