<div id="atas" class="row mb-3">
    <div class="col">
        <div class="row">
            <div class="col-md-6">
                <h3>Ubah Perkembangan Gizi Anak</h3>
            </div>
            <div class="col-md-6">
                <a href="?page=perkembangangizidata" class="btn btn-primary float-end">
...
<div id="tengah">
    <div class="col">
        ...
        if (isset($_POST['simpan_button'])) {
            ...
            $updateSQL = "UPDATE perkembangan_gizi SET anak_id=$anak_id, 
                bb='$bb',
                tb='$tb', 
                tanggal='$tanggal', 
        ...
        $id = $_GET['id'];
        $selectSQL = "SELECT * FROM perkembangan_gizi WHERE id=$id";
        $result = mysqli_query($koneksi, $selectSQL);
        if (!$result || mysqli_num_rows($result) == 0) {
            echo "<meta http-equiv='refresh' content='0;url=?page=perkembangangizidata'>";
        } else {
    ...
    <div class="col">
        <div class="card px-3 py-3">
            <form action="" method="post">
                ...
                <?php
                $baikSelected = $row["status_gizi"] == "Baik" ? " selected" : "";
                $kurangSelected = $row["status_gizi"] == "Kurang" ? " selected" : "";
                ?>
                <div class="mb-3">
                    <label for="id">Status Gizi</label>
                    <select name="status_gizi" id="" class="form-control" required>
                        <option value="">-- Pilih --</option>
                        <option value="Baik" <?= $baikSelected ?>>Baik</option>
                        <option value="Kurang" <?= $kurangSelected ?>>Kurang</option>
                    </select>
                </div>
                <div class="col mb-3">
